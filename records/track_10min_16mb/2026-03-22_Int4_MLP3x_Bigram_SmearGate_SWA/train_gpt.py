...
class EMA:
    ...
    def update(self, model: nn.Module, step: int) -> None:
        ...
        if step < self.start_step:
            # Before start_step, copy current params (warmup phase)
            for name, param in model.named_parameters():
...
def main() -> None:
    ...
    while True:
        ...
        if should_log_train:
            log0(f"step:{step}/{args.iterations} train_loss:{train_loss.item():.4f} train_time:{approx_training_time_ms:.0f}ms")
